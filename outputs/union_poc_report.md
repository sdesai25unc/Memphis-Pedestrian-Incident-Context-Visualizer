...
- Total: **47** (9 fatal)  *(deadliest-list anchor ≈ 36/8; the 30 m buffer catches a few more than the nearest-street assignment)*.
- **Crossing-relevant (On Roadway / In Crosswalk): 41** (8 fatal) — the headline set.
...
- mean **168 ft (51 m)**, median **5 ft (2 m)**, max 864 ft (263 m).
- struck **> 100 ft** from the nearest safe crossing: **16/41 (39%)**; **> 250 ft**: **10/41 (24%)**.
- **Bimodal split:** **25 struck AT/near a Union crossing** (≤100 ft), **10 struck in a gap** (>250 ft), 6 in between — of 41 crossing-relevant.
