...
In-Memphis crashes: **1375** (183 fatal) = surface **1338** + limited-access **37**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1338) | 1063 (79.4%) | 275 (20.6%) |
| ALL — upper (+62 corner) | 1001 (74.8%) | 337 (25.2%) |
...
- surface 1338 + limited-access 37 = **1375** (expected 1375) ✓
