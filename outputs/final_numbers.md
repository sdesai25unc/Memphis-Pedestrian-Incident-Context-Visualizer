...
In-Memphis crashes: **1394** (184 fatal) = surface **1357** + limited-access **37**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1357) | 1078 (79.4%) | 279 (20.6%) |
| ALL — upper (+64 corner) | 1014 (74.7%) | 343 (25.3%) |
...
- surface 1357 + limited-access 37 = **1394** (expected 1394) ✓
