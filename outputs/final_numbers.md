...
In-Memphis crashes: **1358** (181 fatal) = surface **1323** + limited-access **35**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1323) | 1051 (79.4%) | 272 (20.6%) |
| ALL — upper (+61 corner) | 990 (74.8%) | 333 (25.2%) |
...
- surface 1323 + limited-access 35 = **1358** (expected 1358) ✓
