...
In-Memphis crashes: **1400** (184 fatal) = surface **1363** + limited-access **37**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1363) | 1081 (79.3%) | 282 (20.7%) |
| ALL — upper (+64 corner) | 1017 (74.6%) | 346 (25.4%) |
...
**FINAL RANGE (lead with this):** surface **City 74.6%–79.3% / TDOT 20.7%–25.4%** (all crashes); **City 68.2%–71.2% / TDOT 28.8%–31.8%** (fatal). Plus limited-access 37 crashes (14 fatal), separate.

## Reconciliation

- surface 1363 + limited-access 37 = **1400** (expected 1400) ✓
