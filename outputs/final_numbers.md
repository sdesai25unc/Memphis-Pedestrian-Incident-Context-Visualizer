...
In-Memphis crashes: **1354** (181 fatal) = surface **1319** + limited-access **35**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1319) | 1048 (79.5%) | 271 (20.5%) |
| ALL — upper (+61 corner) | 987 (74.8%) | 332 (25.2%) |
...
- surface 1319 + limited-access 35 = **1354** (expected 1354) ✓
