...
In-Memphis crashes: **1402** (185 fatal) = surface **1365** + limited-access **37**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1365) | 1081 (79.2%) | 284 (20.8%) |
| ALL — upper (+64 corner) | 1017 (74.5%) | 348 (25.5%) |
...
- surface 1365 + limited-access 37 = **1402** (expected 1402) ✓
