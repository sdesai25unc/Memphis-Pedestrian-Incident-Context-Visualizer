...
In-Memphis crashes: **1390** (184 fatal) = surface **1353** + limited-access **37**.

**Surface City vs TDOT — point estimate (corner crashes as city) + range upper bound:**

| | City | TDOT |
|---|---|---|
| ALL — point (1353) | 1075 (79.5%) | 278 (20.5%) |
| ALL — upper (+63 corner) | 1012 (74.8%) | 341 (25.2%) |
...
- surface 1353 + limited-access 37 = **1390** (expected 1390) ✓
