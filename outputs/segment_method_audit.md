...
Wrote shelby_crashes_named_seg.csv, shelby_crashes_classified_seg.csv, deadliest_streets_seg.csv (550 streets).
...
|---|---|---|---|---|
| OLD distance (n=1370) | 1020 (74.5%) | 350 (25.5%) | (in City) | (in City) |
| NEW segment, surface (n=1338) | 1065 (79.6%) | 273 (20.4%) | 24 sep. | 8 sep. |
...
**Crashes that changed label: 427 of 1370** (reconciles: sum still 1370; fatal 181).

```
  TDOT               -> TDOT state route   : 221
...
**Reframe check:** new surface split City 79.6% vs TDOT 20.4% — City still owns the majority of surface crashes; fatal surface City 72.2% vs TDOT 27.8%.
